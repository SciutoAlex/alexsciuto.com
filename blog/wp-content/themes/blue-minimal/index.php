...
<div id="main-gradient">
	<div id="tags" class="maincolumn font-BebasRegular">
		...
		<div class="left-column font-bold">Random Posts</div> <div class="right-column font-body">
		<?php
...
<div id="nextlast">
	<div class="font-bold">
		<?php next_posts_link('« Older Entries', 0) ?> :: <?php previous_posts_link('Newer Entries »', 0); ?>
	</div>
	</div>
	</div>
	</div>
