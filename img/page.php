        ...
        <div id="top-info">
          <div style="background-color:#fff;">
            <div class="fleft">
              ...
              <h1 class="logo">
                <a href="/">
                  <span>&nbsp; Interaction Design and Prototyping</span><img src="/img/alex-logo.jpg"></a></h1>
            </div>
            ...
            <div class="fright">
              <ul class="nav">
                ...
                <li>
                  <p class="small"><a href="/">Projects</a></p>
                </li>
              </ul>
            </div>
           <div class="clear"></div>  
          ...
          <div class="gradient" style="display:none; height:4px; width:1020px;"></div>   
         <div class="clear"></div>  
        </div>
  ...
  function page_bottom() { 
    ...
    <script type="text/javascript">
            ...
            if(($(window).scrollTop() > 110) && logoTransition == false) {
              ...
              $logospan.fadeOut(speed, function() {
                ...
                $logoimg.animate({
                  ...
                  $logoimg.attr('src', '/img/alex-logo-off.jpg');
              ...
              $logospan.fadeOut(speed, function() {
                ...
                $logoimg.animate({
                  ...
                  $logoimg.attr('src', '/img/alex-logo.jpg');
        ...
        var template = Mustache.compile($('#boxTemplate').html());
          ...
          $.getJSON("/js/project-data.json", function(root) {
         var i = 1;
            for(var project in root) {
              
             var currentProject = root[project];
             
             var box = $(template(currentProject)).appendTo('.bottomboxes');
              
              if(i%5 == 0) box.find('.box').css('margin', 0);
    ...
    <div class="box fleft">
      <img src="{{onImage}}">
      <img class="off" src="{{offImage}}">
      
      <div class="clear"></div>
      <p class="medium">{{{medium}}}, {{{date}}}</p>
